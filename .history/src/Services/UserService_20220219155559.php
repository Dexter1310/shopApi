...
class UserService
{
    ...
    function findUser($user,$data){

    $us=$this->entityManager->getRepository(User::class)->findOneBy($user);



     dump($data->get('user')['_token']);die();
        // $token = new UsernamePasswordToken($us, $us->getEmail(), 'main', $us->getRoles());
